...
visit the following url to download csv data to the application for seeding. Add the csv file to 'db/csv'.
...
You're ready to launch! in the console fire up SHOTGUN and visit the BikeShare welcome page:
